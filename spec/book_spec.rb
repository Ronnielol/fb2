...
describe Fb2::Book do
  ...
  describe "#description" do
    ...
    describe "#title_info" do
      ...
      specify "#annotation" do
        ...
        expect(annotation.text[0].text[0].value).to eq("Это тестовый файл FictionBook 2.0. Создан Грибовым Дмитрием\n\t\t\t\tв демонстрационных целях и для экспериментов с библиотекой\n\t\t\t\tFIctionBook.lib. К сожалению сам роман я в FB2 пока не перевел.")
        ...
        expect(annotation.text[5].text[2].value).to eq(".\n\t\t\t\t")
      end
  ...
  specify "#body" do
    ...
    expect(bodies[0].text[2].text[1].text[0].text[0].value).to eq("На самом деле тут нет никакого эпиграфа. Эпиграф добавил Грибов Дмитрий в демонстрационных целях. Тут можно ставить пустые строки:")
    ...
    expect(bodies[0].text[2].text[1].text[2].text[0].value).to eq("и любое другое форматирование.")
    ...
    expect(bodies[0].text[2].text[1].text[3].text[0].value).to eq("Грибов Дмитрий")
    ...
    expect(bodies[0].text[2].text[2].text[1].text[1].text[0].value).to eq("Еh bien, mon prince. Gênes et Lucques ne sont plus que des apanages, des")
    ...
    expect(bodies[0].text[2].text[2].text[1].text[3].text[0].value).to eq("de la famille Buonaparte. Non, je vous préviens, que si vous ne me dites pas, que nous avons la guerre, si vous vous permettez encore de pallier toutes les infamies, toutes les atrocités de cet Antichrist (ma parole, j'y crois) -- je ne vous connais plus, vous n'êtes plus mon ami, vous n'êtes plus")
    ...
    expect(bodies[0].text[2].text[2].text[1].text[7].value).to eq(".\n\t\t\t Ну, здравствуйте, здравствуйте. ")
    ...
    expect(bodies[0].text[2].text[2].text[1].text[8].text[0].value).to eq("Je vois que je vous fais peur")
    ...
    expect(bodies[0].text[2].text[2].text[2].text[0].value).to eq("Так говорила в июле 1805 года известная Анна Павловна Шерер, фрейлина и приближенная императрицы Марии Феодоровны, встречая важного и чиновного князя Василия, первого приехавшего на ее вечер. Анна Павловна кашляла несколько дней, у нее был ")
    ...
    expect(bodies[0].text[2].text[2].text[2].text[4].value).to eq(" был тогда новое слово, употреблявшееся только редкими). В записочках, разосланных утром с красным лакеем, было написано без различия во всех:")
    ...
    expect(bodies[0].text[2].text[2].text[3].text[0].value).to eq("\"Si vous n'avez rien de mieux à faire, M. le comte (или mon prince), et si la perspective de passer la soirée chez une pauvre malade ne vous effraye pas trop, je serai charmée de vous voir chez moi entre 7 et 10 heures. Annette Scherer\"")
    ...
    expect(bodies[0].text[2].text[2].text[3].text[2].value).to eq(".\n\t\t\t\t")
    ...
    expect(bodies[0].text[2].text[2].text[4].text[1].text[0].value).to eq("Dieu, quelle virulente sortie")
    ...
    expect(bodies[0].text[2].text[2].text[4].text[3].value).to eq(" - отвечал, нисколько не смутясь такою встречей, вошедший князь, в придворном, шитом мундире, в чулках, башмаках, при звездах, с светлым выражением плоского лица. Он говорил на том изысканном французском языке, на котором не только говорили, но и думали наши деды, и с теми тихими, покровительственными интонациями, которые свойственны состаревшемуся в свете и при дворе значительному человеку. Он подошел к Анне Павловне, поцеловал ее руку, подставив ей свою надушенную и сияющую лысину, и покойно уселся на диване.")
    ...
    expect(bodies[0].text[2].text[2].text[5].text[1].text[0].value).to eq("Avant tout dites moi, comment vous allez, chère amie?")
    ...
    expect(bodies[0].text[2].text[2].text[5].text[3].value).to eq(" Успокойте друга, - сказал он, не изменяя голоса и тоном, в котором из-за приличия и участия просвечивало равнодушие и даже насмешка.")
    ...
    expect(bodies[0].text[2].text[3].text[0].text[0].text[0].value).to eq("Это пример глубоко вложенных частей")
    ...
    expect(bodies[0].text[2].text[3].text[1].text[1].text[0].value).to eq("Представляется логичным, что искусство индуктивно - это напряженный закон внешнего мира. Преамбула иллюзорна. Постмодернизм может быть получен из опыта. Представление, как принято считать, раскладывает на элементы смысл жизни, условно. Универсальное рефлектирует себя через интеллект.")
    ...
    expect(bodies[0].text[2].text[3].text[2].text[0].text[0].text[0].value).to eq("Рыба (1.II)")
    ...
    expect(bodies[0].text[2].text[3].text[2].text[2].text[0].value).to eq("Смысл жизни неоднозначен. Предметность ассоциирует класс эквивалентности, исходя из принятого мнения. Сомнение индуцирует интеллект. Любовь категорически осмысляет примитивный принцип восприятия.")
    ...
    expect(bodies[0].text[2].text[3].text[2].text[3].text[0].value).to eq("Структурализм оспособляет постсовременный конфликт, изменяя привычную реальность. Поливалентность решительно подрывает субъективный смысл жизни, отрицая очевидное. Реальная власть, пренебрегая деталями, дискредитирует постмодернизм, учитывая известные обстоятельства. Искусство амбивалентно. Класс эквивалентности не так уж очевиден. Философия трансформирует неоднозначный мир. Структурализм - это типичный смысл жизни. Ощущение мира осмысленно фокусирует трагический объект деятельности.")
    ...
    expect(bodies[0].text[2].text[3].text[2].text[4].text[0].value).to eq("Общество подрывает естественный интеллект. Согласно мнению известных философов принцип восприятия непредвзято заполняет постмодернизм. Конфликт может быть получен из опыта. Смысл жизни порождает и обеспечивает структурализм. Класс эквивалентности прост.")
    ...
    expect(bodies[0].text[2].text[3].text[2].text[5].text[0].value).to eq("Созерцание оспособляет примитивный структурализм, отрицая очевидное. Страсть порождает и обеспечивает непредвиденный класс эквивалентности. Можно предположить, что смысл жизни не так уж очевиден. Закон внешнего мира абстрактен.")
    ...
    expect(bodies[0].text[2].text[3].text[3].text[0].text[0].text[0].value).to eq("Рыба (1.III)")
    ...
    expect(bodies[0].text[2].text[3].text[4].text[3].text[0].text[0].text[0].value).to eq("Рыба (1.IV.в)")
    ...
    expect(bodies[0].text[2].text[3].text[4].text[3].text[1].text[0].text[0].text[0].value).to eq("Рыба (1.IV.в.A)")
    ...
    expect(bodies[0].text[2].text[3].text[4].text[4].text[0].text[0].text[0].value).to eq("Рыба (1.IV.в)")
    ...
    expect(bodies[0].text[2].text[3].text[4].text[4].text[1].text[0].text[0].text[0].value).to eq("Рыба (1.IV.в.A)")
    ...
    expect(bodies[0].text[2].text[3].text[4].text[4].text[1].text[1].text[0].text[0].text[0].value).to eq("Рыба (1.IV.в.A.0)")
    ...
    expect(bodies[0].text[2].text[3].text[4].text[4].text[1].text[1].text[1].text[0].text[0].text[0].value).to eq("Рыба (1.IV.в.A.0.q)")
    ...
    expect(bodies[0].text[2].text[3].text[4].text[4].text[1].text[1].text[1].text[1].text[0].value).to eq("Акция вырождена. Объект деятельности натурально подрывает из ряда вон выходящий класс эквивалентности, условно. Принцип восприятия, в рамках сегодняшних воззрений, ясен не всем. Освобождение амбивалентно.")
    ...
    expect(bodies[0].text[2].text[3].text[4].text[4].text[1].text[1].text[2].text[0].text[0].text[0].value).to eq("Рыба (1.IV.в.A.0.q)")
    ...
    expect(bodies[0].text[2].text[3].text[4].text[4].text[1].text[1].text[2].text[1].text[0].value).to eq("Постмодернизм неоднозначен. Напряжение трансформирует конфликт. Созерцание осмысленно профанирует объект деятельности. Смысл жизни категорически раскладывает на элементы паллиативный интеллект. Жизнь принимает во внимание постмодернизм, отрицая очевидное. Свобода ментально порождает и обеспечивает типичный класс эквивалентности. Мир - это субъективный структурализм.")
    ...
    expect(bodies[0].text[2].text[4].text[2].text[0].text[0].text[0].value).to eq("В приятну ночь, при лунном свете,")
    ...
    expect(bodies[0].text[2].text[4].text[2].text[0].text[1].text[0].value).to eq("Представить счастливо себе,")
    ...
    expect(bodies[0].text[2].text[4].text[2].text[0].text[2].text[0].value).to eq("Что некто есть еще на свете,")
    ...
    expect(bodies[0].text[2].text[4].text[2].text[0].text[3].text[0].value).to eq("Кто думает и о тебе!")
    ...
    expect(bodies[0].text[2].text[4].text[2].text[0].text[4].text[0].value).to eq("Что и она, рукой прекрасной,")
    ...
    expect(bodies[0].text[2].text[4].text[2].text[0].text[5].text[0].value).to eq("По арфе золотой бродя,")
    ...
    expect(bodies[0].text[2].text[4].text[2].text[0].text[6].text[0].value).to eq("Своей гармониею страстной")
    ...
    expect(bodies[0].text[2].text[4].text[2].text[0].text[7].text[0].value).to eq("Зовет к себе, зовет тебя!")
    ...
    expect(bodies[0].text[2].text[4].text[2].text[0].text[8].text[0].value).to eq("Еще день, два, и рай настанет...")
    ...
    expect(bodies[0].text[2].text[4].text[2].text[0].text[9].text[0].value).to eq("Но ах! твой друг не доживет!")
    ...
    expect(bodies[1].text[2].text[1].text[0].value).to eq("Ну, что, князь, Генуа и Лукка стали не больше, как поместьями фамилии Бонапарте. Нет, я вас предупреждаю, если вы мне не скажете, что у нас война, если вы еще позволите себе защищать все гадости, все ужасы этого Антихриста (право, я верю, что он Антихрист)- я вас больше не знаю, вы уж не друг мой, вы уж не мой верный раб, как вы говорите.")
    ...
    expect(bodies[1].text[3].text[1].text[0].value).to eq("Я вижу, что я вас пугаю,")
    ...
    expect(bodies[1].text[4].text[1].text[0].value).to eq("Если y вас, граф (или князь), нет в виду ничего лучшего и если перспектива вечера у бедной больной не слишком вас пугает, то я буду очень рада видеть вас нынче у себя между семью и десятью часами. Анна Шерер.")
    ...
    expect(bodies[1].text[5].text[1].text[0].value).to eq("О! какое жестокое нападение!")
    ...
    expect(bodies[1].text[6].text[1].text[0].value).to eq("Прежде всего скажите, как ваше здоровье?")
  end
end
